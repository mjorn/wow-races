...
public enum WowClass {
    ...
    SHAMAN("Shaman", R.color.shamanColor, "Elemental · Enchancement · \nRestoration", R.drawable.classes_shaman),
    HUNTER("Hunter", R.color.hunterColor, "Beast Mastery · Survival · \nMarksmanship", R.drawable.classes_hunter),

    DRUID("Druid", R.color.druidColor, "Restoration · Balance · \nGuardian · Feral", R.drawable.classes_druid),
